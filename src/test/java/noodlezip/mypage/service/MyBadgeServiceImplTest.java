...
import noodlezip.badge.service.BadgeCategoryService;
import noodlezip.badge.service.BadgeService;
...
import noodlezip.mypage.dto.response.badge.*;
...
class MyBadgeServiceImplTest {
    ...
    void getUserBadgeListByGroup_성공() {
        ...
        // notOptionBadgeList
        List<UserNoOptionBadgeDto> notOptionBadgeList = List.of(
        ...
        // optionBadgeList
        List<UserOptionBadgeDto> optionBadgeList = List.of(
        ...
        when(userBadgeService.getBadgeGroupIds()).thenReturn(badgeGroupList);
    ...
    void getBadgeDetailList_성공() {
        ...
        List<LevelBadgeDetailResponse> levelBadgeDetailList = List.of(
