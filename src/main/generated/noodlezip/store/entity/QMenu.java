...
public class QMenu extends EntityPathBase<Menu> {
    ...
    public final NumberPath<Integer> ramenCategoryId = createNumber("ramenCategoryId", Integer.class);

    public final NumberPath<Integer> ramenSoupId = createNumber("ramenSoupId", Integer.class);
