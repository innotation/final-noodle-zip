...
public enum BoardSuccessStatus implements BaseCode {
    ...
    _OK_COMMENT_ADDED(HttpStatus.CREATED, "COMMENT-002", "댓글이 추가되었습니다."),
    ...
    _OK_PHOTO_ADDED(HttpStatus.CREATED, "BOARD-003", "사진이 추가되었습니다."),
    _OK_BOARD_ADDED(HttpStatus.CREATED, "BOARD-004", "게시글 추가가 완료되었습니다."),
    ;
